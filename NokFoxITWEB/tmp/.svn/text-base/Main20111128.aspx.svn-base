<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Main20111128.aspx.cs" Inherits="Main"
                ...
                <tr>
                    <td id="TopicBar" class="leftMenu" style="width: 20%; height: 100%;" valign="top">
                        ...
                        <div id="time">
                            ...
                            Text="Picture" Width="75px" />
                        &nbsp;
                        &nbsp;
                            <asp:Button ID="Button7" runat="server" Height="20px" onclick="Button4_Click" 
                            Text="Picture" Width="75px" />
                        &nbsp;<br />
                            <asp:Button ID="Button8" runat="server" Height="20px" onclick="Button4_Click" 
                            Text="Picture" Width="75px" />
