<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnterFactReasonAdd.aspx.cs"
    Inherits="Pub_EnterFactReasonAdd" StylesheetTheme="SkinFile" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="titleImgAdd" style="width: 899px">
                    <asp:Label ID="lblHead" runat="server" SkinID="lblTitleAdd">新增入廠原因</asp:Label>
                </td>
            </tr>
            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="TextTable">
                        <tr>
                            <td class="TdRight" style="height: 22px">
                                <asp:Label ID="lblReasonCode" runat="server" SkinID=lblRed>原因編號:</asp:Label></td>
                            <td class="Tdleft" style="height: 22px">
                                <asp:TextBox ID="txtReasonCode" runat="server" MaxLength="20" SkinID="txtMain" Enabled="False"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="TdRight" style="height: 22px">
                                <asp:Label ID="lblDescription" runat="server" SkinID=lblRed>原因描述:</asp:Label></td>
                            <td class="Tdleft" style="height: 22px">
                                <asp:TextBox ID="txtDescription" runat="server" MaxLength="50" SkinID="txtMain" Enabled="False" Width="377px" TextMode="MultiLine"></asp:TextBox></td>
                        </tr>
                        <tr visible="false">
                            <td style="height: 22px">
                            </td>
                            <td style="height: 22px" visible="false">
                                <asp:TextBox ID="txtMemo" runat="server" Width="28px" Visible="false"></asp:TextBox>
