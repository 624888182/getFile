<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FMDN01.aspx.cs" Inherits="MainMSPrg_FMDN01" %>
...
<body>
    ...
    <div>
    <center><h1><b><font color ="#0099ff" style="font-family: 標楷體">DN&nbsp;Query</font></b></h1></center>
    </div>
    <div>
        <fieldset>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%" class="input-table">
                <tr>
                    ...
                    <font color ="#0066ff" ><b>Create Date from：</b></font>
                    </td>
                    ...
                    <td align="left" class="auto-style1">
                    <font color ="#0066ff" ><b>Create Date end：</b></font></td>
                    <td align="left" style="width: 130px">
                ...
                <tr style="height: 28px" valign="bottom">
                    ...
                    <td align="left" colspan="6">
                        <asp:Button ID="Button3" runat="server" BackColor="#FFCC00" BorderColor="White" ForeColor="#3366FF" style="font-weight: 700" Text="GetSAP" Width="70px" OnClick="Button3_Click" />
                    </td>
                </tr>
            </table>
        </fieldset>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="tCreationDT" HeaderText="CreationDT" ReadOnly="True" />
                <asp:BoundField DataField="tIssueDT" HeaderText="PickingDT" />
                <asp:BoundField DataField="tArrivalDT" HeaderText="DeliveryDT" />
                <asp:BoundField DataField="WayBillID" HeaderText="LoadID" />
                <asp:BoundField DataField="ProductRecipientID" HeaderText="CarrierID" />
                <asp:BoundField DataField="GrossUnitCode" HeaderText="GrossUnitCode" ReadOnly="True" />
                <asp:BoundField DataField="GrossWeight" HeaderText="GrossWeight" ReadOnly="True" />
                <asp:BoundField DataField="NetUnitCode" HeaderText="NetUnitCode" ReadOnly="True" />
                ...
                <asp:BoundField DataField="SendFlag" HeaderText="SendFlag" ReadOnly="True" />                
                <asp:BoundField DataField="SendTime" HeaderText="SendTime" ReadOnly="True" />
                <asp:BoundField DataField="SendLog" HeaderText="SendLog" ReadOnly="True" />
            </Columns>
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="POItemID" HeaderText="POItemID" />
                <asp:BoundField DataField="InternalID" HeaderText="InternalID" />
                <asp:BoundField DataField="ProductRecipientID" HeaderText="MSMaterialNO" ReadOnly="True" />
                <asp:BoundField DataField="Total_QTY" HeaderText="Total_QTY" ReadOnly="True" />
                <asp:BoundField DataField="UNIT" HeaderText="UNIT" ReadOnly="True" />
                <asp:BoundField DataField="Carton_QTY" HeaderText="Carton_QTY" ReadOnly="True" />
                <asp:BoundField DataField="Pallet_QTY" HeaderText="Pallet_QTY" ReadOnly="True" />
            </Columns>
            <FooterStyle BackColor="White" ForeColor="#333333" />
                    <%-- <PagerStyle BackColor="#507CD1" ForeColor="White" HorizontalAlign="Center" />--%>
                    <SelectedRowStyle BackColor="#339966" Font-Bold="True" ForeColor="White" />
