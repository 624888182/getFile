 ...
 <div id="div1" runat="server" align="left">
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="White" AutoGenerateColumns="False"
                ...
                <Columns> 
                    ...
                    <asp:BoundField DataField="PO_CREATE_MT_UF8" HeaderText="SEND3B2FLAG" />
                    <asp:BoundField DataField="PO_CREATE_MT_UF8" HeaderText="SEND3B2Time" />
...
<%--                                 <asp:BoundField DataField="Address_UF1" HeaderText="company" />--%>
                                ...
                                <asp:BoundField DataField="CityName" HeaderText="CityName" />
                                <asp:BoundField DataField="CountryCode" HeaderText="CountryCode" />
                                <asp:BoundField DataField="Address_UF2" HeaderText="RegionCode" />
                                <asp:BoundField DataField="Address_UF2" HeaderText="PostalCode" />
                                <asp:BoundField DataField="Address_UF2" HeaderText="LanguageCode" />
                                <asp:BoundField DataField="Address_UF2" HeaderText="FAXnumber" />
                                <asp:BoundField DataField="Address_UF2" HeaderText="telnumber" />
