...
public partial class MainBBRYPrg_BBSCMPODetail : System.Web.UI.Page
{
  ...
  //public string  ID = string.Empty;
    ...
    public void selecttable()
    {
        ...
        strSQL = strSQL + "PO_CREATE_DT_UF9,PO_CREATE_DT_UF10 ,POCNT,CostAmount FROM "+BBSCMDIR+".[dbo].[PO_CREATE_DT]  where 1=1 ";

        strSQL = strSQL + " and ID='" + ID + "' and ITEMID ='"+Session["ITEMID"].ToString ()+"'";
      ...
      FROM " + BBSCMDIR + ".dbo.PO_CREATE_DT where ID='" + ID + "'";
        ...
        GetSql = "SELECT  sum( CAST(QTY AS NUMERIC(10))) AS QTY  FROM  PO_CONFIRMATION_MT where POID= '" + dtt.Rows[0]["POID"].ToString() + "' and ITEMID ='" + dtt.Rows[0]["ITEMID"].ToString() + "' ";
    ...
    protected void InsertRow(string ID, string POID, string ACCEPTSTATUSCODE, string ITEMID, string SCHEDULELINEID, string QTY, string DELIVERYSTARTDT, string DELIVERYENDDT)
    {
        ...
        strSQL = strSQL + "'" + QTY + "' ,'" + DELIVERYSTARTDT + "','" + DELIVERYENDDT + "','"+Label72.Text+"' )";
        ...
        int dt = PDataBaseOperation.PExecSQL(DBType, connstr, strSQL);
         ...
         strSQL=   "   update PO_CREATE_DT  set CONFIRM_ADD_FLAG='Y' where ID='"+ID+"'  and ITEMID='"+ITEMID+"' ";
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            Response.Write("<script>alert('Total ITEM QTY is:" + Label70.Text + ",Iput is: " + Label70.Text + ii + " ,Please check your key in data!!');</script>");
    ...
    protected void GridView_Edit(object sender, GridViewEditEventArgs e)
    {
        ...
        Server.Transfer("BBSCMPO_ITEM_Detail.aspx");
