...
using System.Data;
using EconomyUser;
public partial class BBSCMPO_ITEM_DetailNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        BBSCMDIR = Session["BBSCMDIR"].ToString();
    ...
    public void selecttable()
    {
        ...
        if (datafrom == "pocreate")
        {
            ...
            UF3 = "PO_CREATE_DT_UF3";
        }
        else
        {
            dtablename = "PO_CHANGE_DT";
            UF3 = "PO_CHANGE_DT_UF3";
        }
        ...
        strSQL = strSQL + ",ScheduleLineUnit,CONFIRMFLAG,CostAmount," + UF3 + " FROM " + dtablename + "  where 1=1 ";
