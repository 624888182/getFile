<%@ Page Language="C#" enableViewStateMac="false"  AutoEventWireup="true" CodeFile="MainNokFox20170629.aspx.cs" Inherits="Main_MainNokFox20170629"
...
&nbsp;1. System Management&nbsp;&nbsp;:&nbsp; BB SCM SFC Web&nbsp;&nbsp;&nbsp;&nbsp;FoxSite :&nbsp;
                        ...
                        <asp:TextBox ID="TextBox8" runat="server" Height="20px" Width="124px" 
                          ...
                          <asp:TextBox ID="TextBox14" runat="server" Height="20px" Width="2px" Visible="False"></asp:TextBox>
                                ...
                                <asp:TextBox ID="TextBox16" runat="server" Height="20px" Width="2px" 
                                        Visible="False"></asp:TextBox>
                                &nbsp;<asp:TextBox ID="TextBox17" runat="server" Height="20px" Width="2px" 
         ...
         &nbsp;6. SCM WebSer&nbsp;:&nbsp;<asp:Button ID="Button62" runat="server" BackColor="#99FF99" 
                            ...
                            <tr>
                                <td class="style12">
                                  &nbsp;8. OutSource&nbsp;&nbsp;&nbsp; :&nbsp;<asp:Button ID="Button76" 
                                        runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                            ...
                            <tr>
                                <td class="style8">
                                    &nbsp;Currency Status :&nbsp; &nbsp;                        &nbsp;Currency Status :&nbsp; &nbsp;<asp:TextBox ID="TextBox6" runat="server" 
