<%@ Page Language="C#" enableViewStateMac="false"  AutoEventWireup="true" CodeFile="MainMS.aspx.cs" Inherits="Main_MainMS"
    StylesheetTheme="SkinFile" %>

<%@ Register Assembly="C1.Web.Command.2" Namespace="C1.Web.Command" TagPrefix="c1c" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>MS SCM Syetem</title>
    <style type="text/css">
     .navPoint 
...
&nbsp; 1)&nbsp; Days (2) DN (3) WO(L6) (4) WO(L10) //&nbsp; Data :&nbsp;
                        <asp:TextBox ID="TextBox8" runat="server" Height="20px" Width="124px" 
                            ...
                            <tr>
                                <td class="style8">
                                    &nbsp;5. SCM DN System&nbsp;&nbsp;DN :
                          <asp:TextBox ID="TextBox10" runat="server" Height="20px" Width="75px" 
                                        ontextchanged="TextBox8_TextChanged"></asp:TextBox>
                                &nbsp;&nbsp; DBA :&nbsp;
                          <asp:TextBox ID="TextBox11" runat="server" Height="20px" Width="75px" 
                                        ontextchanged="TextBox8_TextChanged"></asp:TextBox>
                                &nbsp;&nbsp;<asp:Button ID="Button57" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="OPEN" Width="80px" onclick="Button57_Click" />
                                    &nbsp;<asp:Button ID="Button75" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="OPEN" Width="78px" onclick="Button75_Click" />
                                    </td>
                                <td class="style3">
                                    &nbsp;</td>
                                <td class="style3">
                            ...
                            <tr>
                                <td class="style8">
                                  &nbsp;6. SCM WebService&nbsp; :&nbsp;<asp:Button ID="Button62" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                    ...
                                    &nbsp;<asp:Button ID="Button36" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="PO Block Recv" Width="80px" onclick="Button36_Click" />
                                &nbsp;<asp:Button ID="Button92" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="3B2 Manage" Width="100px" onclick="Button36_Click" />
                                &nbsp;<asp:Button ID="Button93" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="3B2 Mamage" Width="100px" onclick="Button36_Click" />
                                    </td>
                                <td class="style3">
                                    &nbsp;</td>
                                <td class="style3">
                            ...
                            <tr>
                                <td class="style12">
                                    &nbsp; 8. DLABEL :&nbsp;                                       <asp:Button ID="Button76" 
                                        runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="22px" 
                                        Text="OPEN" Width="80px" onclick="Button76_Click" />
                                &nbsp;<asp:Button ID="Button77" 
                                        runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="22px" 
                                        Text="OPEN" Width="80px" onclick="Button77_Click" />
                                    &nbsp;
                                    <asp:Button ID="Button78" 
                                        runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="22px" 
                                        Text="OPEN" Width="80px" onclick="Button78_Click" />
                                    &nbsp;&nbsp; <asp:Button ID="Button63" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="OPEN" Width="100px" onclick="Button63_Click" />
                                    <asp:Button ID="Button88" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="OPEN" Width="86px" onclick="Button88_Click" />
                                    </td>
                                <td class="style13">
                                    &nbsp;</td>
                                <td class="style13">
                            ...
                            <tr>
                                <td class="style14">
                                    ...
                                    <asp:Button ID="Button79" 
                                        runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="22px" 
                                        Text="OPEN" Width="95px" onclick="Button79_Click" />
                                    &nbsp;<asp:Button ID="Button80" 
                                        runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="22px" 
                                        Text="OPEN" Width="95px" onclick="Button80_Click" />
                                    &nbsp;<asp:Button ID="Button81" 
                                        runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="22px" 
                                        Text="OPEN" Width="95px" onclick="Button81_Click" />
