<%@ Page Language="C#" enableViewStateMac="false"  AutoEventWireup="true" CodeFile="MainNokFox20170630.aspx.cs" Inherits="Main_MainNokFox20170630"
...
&nbsp; 1. System Management&nbsp;&nbsp;:&nbsp; BB SCM SFC Web&nbsp;&nbsp;&nbsp;&nbsp;FoxSite :&nbsp;
                        ...
                        <asp:TextBox ID="TextBox8" runat="server" Height="20px" Width="124px" 
                                        ontextchanged="TextBox8_TextChanged"></asp:TextBox>
                                &nbsp;&nbsp;&nbsp;
                          <asp:TextBox ID="TextBox14" runat="server" Height="20px" Width="2px" Visible="False"></asp:TextBox>
                                &nbsp;<asp:TextBox ID="TextBox15" runat="server" Height="20px" Width="2px" 
                                        Visible="False"></asp:TextBox><asp:TextBox ID="TextBox16" runat="server" Height="20px" Width="2px" 
                                        Visible="False"></asp:TextBox>&nbsp;<asp:TextBox ID="TextBox17" runat="server" Height="20px" Width="2px" 
                          ...
                          <asp:TextBox ID="TextBox13" runat="server" Height="20px" Width="75px"></asp:TextBox>
                                &nbsp;
                                    <asp:Button ID="Button57" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="OPEN" Width="40px" onclick="Button57_Click" />
                                    &nbsp;<asp:Button ID="Button75" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="OPEN" Width="40px" onclick="Button75_Click" />
                                    </td>
                                <td class="style3">
                                    &nbsp;</td>
                                <td class="style3">
                        ...
                        &nbsp;6. SCM WebSer :&nbsp;<asp:Button ID="Button62" runat="server" BackColor="#99FF99" 
                                ...
                                &nbsp;<asp:Button ID="Button93" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="Automatic" Width="65px" onclick="Button93_Click" />
                                    &nbsp;<asp:Button ID="Button71" runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
                                        Text="DN up PO" Width="65px" onclick="Button71_Click" />
                                    </td>
                                <td class="style3">
                                    &nbsp;</td>
                                <td class="style3">
                            ...
                            <tr>
                                <td class="style8">
                                    &nbsp;9. E-Kanban&nbsp;&nbsp;&nbsp; &nbsp; :&nbsp;                                       <asp:Button ID="Button79" 
                                        runat="server" BackColor="#99FF99" 
                                        BorderColor="White" BorderStyle="Dotted" ForeColor="#CC00FF" Height="20px" 
