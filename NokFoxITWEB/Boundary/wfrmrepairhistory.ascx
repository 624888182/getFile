<%@ Control Language="c#" Inherits="SFCQuery.Boundary.WFrmRepairHistory" CodeFile="WFrmRepairHistory.ascx.cs" %>
...
<TABLE class="DataGridFont" id="Table1" cellSpacing="0" cellPadding="0" border="0">
	...
	<TR>
		...
		<TD>
			<asp:Label id="lblStationID" runat="server" Width="100px" Visible="False">Station ID</asp:Label></TD>
		<td>
			<asp:DropDownList id="ddlStationID" runat="server" Width="155px" Visible="False"></asp:DropDownList></td>
	</TR>
</TABLE>
<hr>
<asp:Label id="Label4" runat="server" CssClass="DataGridFont"></asp:Label>
<br>
<asp:DataGrid id="dgRepairHistory" runat="server" Width="100%" CssClass="DataGridFont" Font-Size="10px"
