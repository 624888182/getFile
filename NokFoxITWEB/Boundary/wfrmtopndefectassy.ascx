...
<%@ Control Language="c#" Inherits="SFCQuery.Boundary.WFrmTopNDefectAssy" CodeFile="WFrmTopNDefectAssy.ascx.cs" %>
...
<table class="DataGridFont" cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<tr>
		<td vAlign="top" align="center" width="30%"><cwc:webdatagrid id="dgDefectTopN" runat="server" Width="272px" CssClass="DataGridFont" SetShowFooter="True"
				...
				<Columns>
					...
					<asp:TemplateColumn HeaderText="QTY">
						...
						<ItemTemplate>
							<asp:LinkButton id=LinkButton1 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.QTY") %>' CausesValidation="false" CommandName="QTY">
							</asp:LinkButton>
                        </ItemTemplate>
		...
		<td vAlign="top" align="center" width="70%" rowSpan="2"><asp:datagrid id="dgDefectDtail" runat="server" CssClass="DataGridFont" AutoGenerateColumns="False"
				BorderStyle="None" BorderWidth="1px" BackColor="White" Font-Size="11px" Font-Names="Verdana" BorderColor="#CCCCCC" ShowFooter="True">
				<SelectedItemStyle Font-Bold="True" ForeColor="White" BackColor="#669999"></SelectedItemStyle>
				<AlternatingItemStyle BackColor="WhiteSmoke"></AlternatingItemStyle>
