<%@ Control Language="C#" AutoEventWireup="true" CodeFile="B2B_Invoice.ascx.cs" Inherits="Boundary_B2B_Invoice" %>
    ...
    <tr>
        ...
        <asp:Panel runat="server" ID="panel2" Width="100%"  > 
            <table class="DataGridFont" cellSpacing="0" cellPadding="0" border="1"  align="center" width="100%">
	            ...
	            <tr>
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label6" runat="server" Width="100px">LoadID:</asp:label></td>
		            <td Width="70%">
		                <table class="DataGridFont" cellSpacing="0" cellPadding="0" border="0">
		                    <tr>
		                        <td>
	            ...
	            <tr>
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label11" runat="server" Width="100px">Invoice No:</asp:label></td>
		            <td Width="70%">
		                <table class="DataGridFont" cellSpacing="0" cellPadding="0" border="0">
		                    <tr>
		                        <td style="height: 82px">
		                            <asp:TextBox ID="txtInvoiceNo" runat="server" TextMode="MultiLine" Width="200px" Height="80px"></asp:TextBox>                      
		                        </td>
		                        <td style="height: 82px">
