<%@ Control Language="c#" Inherits="SFCQuery.Boundary.WFrmEfficiencyAssyQuery" CodeFile="WFrmEfficiencyAssyQuery.ascx.cs" %>
...
<hr>
<asp:datagrid id="dgPCBA" runat="server" Width="272px" CssClass="DataGridFont" CellPadding="3"
