...
namespace SFCQuery.Boundary
{
	...
	/// </summary>
	public partial class WFrmTopNDefectAssy : System.Web.UI.UserControl
	{
		...
		protected void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			//DataTable dt = clsDBTopNDefect.GetAssyData(strStartDate,strEndDate,strLine,strTopN,intRegion,intType,intStatisticsType,0,strModel,strWO,blRepair,out ReturnMsg);
			...
			clsDBTopNDefect.createChart(WebChartViewer1,DefectDesc,DefectQty,"Pack TOP "+strTopN+" Defect(PCS)");
...
//				}
			...
			if (e.CommandName.ToUpper()=="QTY")
			{
                ...
                string strStation = ((Label)(e.Item.Cells[6].Controls[1])).Text;
                ...
                strDefectMsg=strDefectMsg.Replace("'", "''").ToString();
                orapara[13].Value = strDefectMsg;
                orapara[14].Value = strStation;
