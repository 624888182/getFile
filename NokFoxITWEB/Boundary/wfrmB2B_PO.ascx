<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wfrmB2B_PO.ascx.cs" Inherits="Boundary_wfrmB2B_PO" %>
    ...
    <tr>
        ...
        <asp:Panel runat="server" ID="panel2" Width="100%"  > 
            <table class="DataGridFont" cellSpacing="0" cellPadding="0" border="1"  align="center" width="100%">
                <tr>
		            <td align="right" width="30%"><asp:label id="lblFromDate" runat="server" ToolTip=" 格式:(yyyy/MM/dd HH:mm)">From Date:</asp:label></td>
		            <td Width="70%">
	            ...
	            <tr> 
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label5" runat="server" >PlantCode:</asp:label></td>
		            <td style="WIDTH: 463px; HEIGHT: 18px"><asp:dropdownlist id="ddlPlantCode" runat="server" Width="155px"  ></asp:dropdownlist></td>
	            </tr>
	            <tr>
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label6" runat="server" Width="100px">CsoNum:</asp:label></td>
		            <td Width="70%">
		                <table class="DataGridFont" cellSpacing="0" cellPadding="0" border="0">
		                    <tr>
		                        <td>
		                            <asp:TextBox ID="txtCsoNum" runat="server" TextMode="MultiLine" Width="200px" Height="80px"></asp:TextBox>		                        
		                        </td>
		                        <td>
		                            <asp:Label ID="lblgeshi3" runat="server"   Text="(以逗號區分,例如:000000480,000000481)  "></asp:Label> 
		                        </td>
		                    </tr>
		                </table> 
		            </td>
	            ...
	            <tr> 
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label9" runat="server" Width="100px">Upload Flag::</asp:label></td>
		            <td Width="70%">
	            ...
	            <tr>  
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label10" runat="server" Width="100px">CTOMOD:</asp:label></td>
		            <td Width="70%"><asp:dropdownlist id="ddlCtoMod" runat="server" Width="155px"  ></asp:dropdownlist></td>
	            </tr>
	            <tr>
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label11" runat="server" Width="100px">SO NO:</asp:label></td>
		            <td Width="70%">
		                <table class="DataGridFont" cellSpacing="0" cellPadding="0" border="0">
		                    <tr>
		                        <td style="height: 82px">
		                            <asp:TextBox ID="txtSoNo" runat="server" TextMode="MultiLine" Width="200px" Height="80px"></asp:TextBox>                      
		                        </td>
		                        <td style="height: 82px">
		                           <asp:Label ID="lblgeshi6" runat="server"  Text="(以逗號區分,例如:000000480,000000481)  "></asp:Label> 
		                        </td>
		                    </tr>
		                </table> 
	            ...
	            <tr> 
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label13" runat="server" Width="100px">INSFC Flag:</asp:label></td>
		            <td Width="70%">
	            ...
	            <tr> 
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label14" runat="server" Width="100px">ACK Flag:</asp:label></td>
		            <td Width="70%">
