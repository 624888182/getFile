<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wfrmB2B_AsBuilt.ascx.cs" Inherits="Boundary_wfrmB2B_AsBuilt" %>
    ...
    <tr>
        ...
        <asp:Panel runat="server" ID="panel2" Width="100%"  > 
            <table class="DataGridFont" cellSpacing="0" cellPadding="0" border="1"  align="center" width="100%">
	            ...
	            <tr>
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label11" runat="server" Width="100px">Batch NO:</asp:label></td>
		            <td Width="70%">
		                <table class="DataGridFont" cellSpacing="0" cellPadding="0" border="0">
		                    <tr>
	            ...
	            <tr> 
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label9" runat="server" Width="100px">Send Flag::</asp:label></td>
		            <td Width="70%">
	            ...
	            <tr> 
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label14" runat="server" Width="100px">Validate Flag:</asp:label></td>
		            <td Width="70%">
