...
<%@ Control Language="c#" Inherits="SFCQuery.Boundary.WFrmSFCSMTQuery" debug="True" CodeFile="WFrmSFCSMTQuery.ascx.cs" %>
...
<table width="100%" border="0">
	<tr>
		<td width="55%" valign="top">
			<!--<div class="DIVScrolling">--><cwc:webdatagrid id="dgSMTnextest" runat="server" Width="272px" Visible="False" SetShowFooter="True" AutoGenerateColumns="False"
				BorderStyle="None" BorderWidth="1px" BackColor="White" SaveSettings="False" DisableSort="False" AllowPaging="True" Font-Size="10px"
				Font-Names="Verdana" DisableSetButton="False" BorderColor="#CCCCCC" AllowSorting="True" sUserLanguage="en-us" DisablePaging="False"
				CellPadding="3" ShowFooter="True" UserID="Any" CssClass="DataGridFont" PageSize="20">
				...
				<Columns>
					<asp:TemplateColumn SortExpression="FWO_NO" HeaderText="Work Order">
						...
						<ItemTemplate>
							<asp:Label id=Label41 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FWO_NO") %>'>
							</asp:Label>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id=TextBox10 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FWO_NO") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FModel" HeaderText="Model">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:Label id=Label50 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FModel") %>'>
							</asp:Label>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id=TextBox20 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FModel") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					...
					<asp:TemplateColumn SortExpression="FFlashing" HeaderText="Flashing">
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FFlashing") %>' CommandName="Flashing" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>				
					<asp:TemplateColumn SortExpression="FPowerOn" HeaderText="PowerOn">
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FPowerOn") %>' CommandName="PowerOn" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>  
			...
			<!--<div class="DIVScrolling">--><cwc:webdatagrid id="dgSMThaier" runat="server" Width="272px" Visible="False" SetShowFooter="True" AutoGenerateColumns="False"
				BorderStyle="None" BorderWidth="1px" BackColor="White" SaveSettings="False" DisableSort="False" AllowPaging="True" Font-Size="10px"
				Font-Names="Verdana" DisableSetButton="False" BorderColor="#CCCCCC" AllowSorting="True" sUserLanguage="en-us" DisablePaging="False"
				CellPadding="3" ShowFooter="True" UserID="Any" CssClass="DataGridFont" PageSize="20">
				<PagerStyle HorizontalAlign="Left" ForeColor="#000066" BackColor="White" Mode="NumericPages"></PagerStyle>
				...
				<Columns>
					<asp:TemplateColumn SortExpression="FWO_NO" HeaderText="Work Order">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:Label id=Label24 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FWO_NO") %>'>
							</asp:Label>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id=TextBox23 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FWO_NO") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FModel" HeaderText="Model">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:Label id=Label25 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FModel") %>'>
							</asp:Label>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox id=TextBox21 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FModel") %>'>
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FLine" HeaderText="Line">
					...
					<asp:TemplateColumn SortExpression="FBOARDTEST" HeaderText="BoardTest">
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FBOARDTEST") %>' CommandName="BoardTest" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FGlue" HeaderText="Glue">
			...
			<cwc:webdatagrid id="dgSMTgsm" runat="server" Width="272px" Visible="False" SetShowFooter="True" AutoGenerateColumns="False"
				BorderStyle="None" BorderWidth="1px" BackColor="White" SaveSettings="False" DisableSort="False" AllowPaging="True" Font-Size="10px"
				Font-Names="Verdana" DisableSetButton="False" BorderColor="#CCCCCC" AllowSorting="True" sUserLanguage="en-us" DisablePaging="False"
				CellPadding="3" ShowFooter="True" UserID="Any" CssClass="DataGridFont" PageSize="20">
				<PagerStyle HorizontalAlign="Left" ForeColor="#000066" BackColor="White" Mode="NumericPages"></PagerStyle>
				...
				<Columns>
					<asp:TemplateColumn SortExpression="FWO_NO" HeaderText="Work Order">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:Label id=Label40 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FWO_NO") %>'>
							</asp:Label>
						</ItemTemplate>
						<EditItemTemplate>
			...
			<!--</div>--><br>
			<!--<div class="DIVScrolling">--><cwc:webdatagrid id="dgAssemblynextest" runat="server" Width="272px" Visible="False" SetShowFooter="True"
				...
				Font-Size="10px" Font-Names="Verdana" DisableSetButton="False" BorderColor="#CCCCCC" AllowSorting="True" sUserLanguage="en-us"
				DisablePaging="False" CellPadding="3" ShowFooter="True" UserID="Any" CssClass="DataGridFont" PageSize="20">
				<PagerStyle HorizontalAlign="Left" ForeColor="#000066" BackColor="White" Mode="NumericPages"></PagerStyle>
				<AlternatingItemStyle BackColor="WhiteSmoke"></AlternatingItemStyle>
				<FooterStyle ForeColor="#000066" BackColor="White"></FooterStyle>
				<SelectedItemStyle Font-Bold="True" ForeColor="White" BackColor="#669999"></SelectedItemStyle>
				...
				<Columns>
					...
					<asp:TemplateColumn SortExpression="PN" HeaderText="Item">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PN") %>' ID="Label17" NAME="Label7">
							</asp:Label>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PN") %>' ID="Textbox13" NAME="Textbox3">
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="WO_Qty" HeaderText="WO Qty">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.WO_Qty") %>' ID="Label18" NAME="Label8">
							</asp:Label>
						</ItemTemplate>
						<EditItemTemplate>
							<asp:TextBox runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.WO_Qty") %>' ID="Textbox14" NAME="Textbox4">
							</asp:TextBox>
						</EditItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FInput" HeaderText="Input">
					...
					<asp:TemplateColumn SortExpression="FPhasing" HeaderText="Phasing">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FPhasing") %>' CommandName="Phasing" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FProto" HeaderText="Proto">
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FProto") %>' CommandName="Proto" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FCIT" HeaderText="CIT">
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FCIT") %>' CommandName="CIT" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FBluetooth" HeaderText="Bluetooth">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FBluetooth") %>' CommandName="Bluetooth" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FFocus" HeaderText="Focus">
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FFocus") %>' CommandName="Focus" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
					...
					<asp:TemplateColumn SortExpression="FRadiated" HeaderText="Radiated">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FRadiated") %>' CommandName="Radiated" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FFQA" HeaderText="FQA">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FFQA") %>' CommandName="FQA" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="FCFC" HeaderText="CFC">
						<HeaderStyle Wrap="False"></HeaderStyle>
						<ItemTemplate>
							<asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FCFC") %>' CommandName="CFC" CausesValidation="false">
							</asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
				</Columns>
			</cwc:webdatagrid>
			<cwc:webdatagrid id="dgAssemblygsm" runat="server" Width="272px" Visible="False" SetShowFooter="True"
				AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px" BackColor="White" SaveSettings="False" DisableSort="False" AllowPaging="True"
				Font-Size="10px" Font-Names="Verdana" DisableSetButton="False" BorderColor="#CCCCCC" AllowSorting="True" sUserLanguage="en-us"
				DisablePaging="False" CellPadding="3" ShowFooter="True" UserID="Any" CssClass="DataGridFont" PageSize="20">
				<PagerStyle HorizontalAlign="Left" ForeColor="#000066" BackColor="White" Mode="NumericPages"></PagerStyle>
			...
			<!--</div>--><br>
			<!--<div class="DIVScrolling">--><cwc:webdatagrid id="dgPacking" runat="server" Width="272px" Visible="False" SetShowFooter="True"
				AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px" BackColor="White" SaveSettings="False" DisableSort="False" AllowPaging="True"
				Font-Size="10px" Font-Names="Verdana" DisableSetButton="False" BorderColor="#CCCCCC" AllowSorting="True" sUserLanguage="en-us"
				DisablePaging="False" CellPadding="3" ShowFooter="True" UserID="Any" CssClass="DataGridFont" PageSize="20">
				<PagerStyle HorizontalAlign="Left" ForeColor="#000066" BackColor="White" Mode="NumericPages"></PagerStyle>
