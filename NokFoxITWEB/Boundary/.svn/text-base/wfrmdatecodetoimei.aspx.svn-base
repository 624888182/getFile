<%@ Page language="c#" Inherits="SFCQuery.Boundary.WFrmDateCodeToImei" CodeFile="WFrmDateCodeToImei.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>WFrmDateCodeToImei</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table align="center"> 
				<tr>
					<td>
						<asp:datagrid id="dgDateCodeDetail" runat="server" BackColor="White" PageSize="20" BorderStyle="None"
