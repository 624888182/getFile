<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wfrmShipOrderQuery.ascx.cs" Inherits="Boundary_wfrmShipOrderQuery" %>
...
<hr>
<asp:datagrid id="dgShiporder" runat="server" Width="100%" CssClass="DataGridFont" Font-Size="10px" 
