...
<%@ Control Language="c#" Inherits="SFCQuery.Boundary.WFrmSFCAssyQuery" debug="True" CodeFile="WFrmSFCAssyQuery.ascx.cs" %>
...
<table class="DataGridFont" cellSpacing="0" cellPadding="0" border="0">
	...
	<tr>
		...
		<td><asp:dropdownlist id="ddlType" runat="server" Width="155px" >
		    <asp:ListItem Text="" Selected="True"></asp:ListItem>
		</asp:dropdownlist><asp:textbox id="tbType" runat="server" Visible="False"></asp:textbox></td>
	</tr>
	<tr>
		<%--<td>
...
<table width="100%" border="0">
	<tr>
		<td width="55%" vAlign="top">
			<!--<div class="DIVScrolling">--><cwc:webdatagrid id="dgSMT" runat="server" Width="272px" Visible="False" SetShowFooter="True" AutoGenerateColumns="False"
			...
			<!--</div>--><br>
			<!--<div class="DIVScrolling">--><cwc:webdatagrid id="dgAssemblygsm" runat="server" Width="272px" Visible="False" SetShowFooter="True"
				...
				DisablePaging="False" CellPadding="3" ShowFooter="True" UserID="Any" CssClass="DataGridFont" PageSize="20" CurrentStatus="" SummaryText="">
				<PagerStyle HorizontalAlign="Left" ForeColor="#000066" BackColor="White" Mode="NumericPages"></PagerStyle>
				<AlternatingItemStyle BackColor="WhiteSmoke"></AlternatingItemStyle>
				<FooterStyle ForeColor="#000066" BackColor="White"></FooterStyle>
				<SelectedItemStyle Font-Bold="True" ForeColor="White" BackColor="#669999"></SelectedItemStyle>
				...
				<Columns>
                    ...
                    <%--<asp:TemplateColumn HeaderText="TBaseBand2" SortExpression="FTBASEBAND2" Visible="False">
                        <itemtemplate>
                        <asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FTBASEBAND2") %>' CommandName="TBaseBand2" CausesValidation="false"></asp:LinkButton>
                        </itemtemplate>
                    </asp:TemplateColumn>--%>
                    ...
                    <asp:TemplateColumn HeaderText="BTWireLess" SortExpression="FBTWireLess">
                        <itemtemplate>
                        <asp:LinkButton runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FBTWireLess") %>' CommandName="BTWireLess" CausesValidation="false"></asp:LinkButton>
                        </itemtemplate>
                    </asp:TemplateColumn>
			...
			<cwc:webdatagrid id="dgAssemblynextest" runat="server" Width="272px" Visible="False" SetShowFooter="True"
				AutoGenerateColumns="False" BorderStyle="None" BorderWidth="1px" BackColor="White" SaveSettings="False" DisableSort="False" AllowPaging="True"
				Font-Size="10px" Font-Names="Verdana" DisableSetButton="False" BorderColor="#CCCCCC" AllowSorting="True" sUserLanguage="en-us"
				DisablePaging="False" CellPadding="3" ShowFooter="True" UserID="Any" CssClass="DataGridFont" PageSize="20" CurrentStatus="" SummaryText="">
				<PagerStyle HorizontalAlign="Left" ForeColor="#000066" BackColor="White" Mode="NumericPages"></PagerStyle>
			...
			<!--</div>--></td>
		<td vAlign="top">
		   <cwc:webdatagrid id="dgPIDDetail" runat="server" Width="272px" CssClass="DataGridFont" UserID="Any"
