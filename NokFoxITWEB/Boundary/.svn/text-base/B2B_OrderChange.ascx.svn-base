<%@ Control Language="C#" AutoEventWireup="true" CodeFile="B2B_OrderChange.ascx.cs" Inherits="Boundary_B2B_OrderChange" %>
        ...
        <asp:Panel runat="server" ID="panel2" Width="100%"  > 
            <table class="DataGridFont" cellSpacing="0" cellPadding="0" border="1"  align="center" width="100%">
	            ...
	            <tr>
	             ...
	             <tr> 
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label3" runat="server" Width="100px">REQ_CHANGE:</asp:label></td>
		            <td Width="70%">
		            <asp:dropdownlist id="ddlREQ_CHANGE" runat="server" Width="80px"  >
	            ...
	            <tr> 
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label4" runat="server" Width="100px">Change Flag:</asp:label></td>
		            <td Width="70%">
		            <asp:dropdownlist id="ddlChangeFlag" runat="server" Width="80px"  >
		                <asp:ListItem Text="All" Selected="True"></asp:ListItem>
	            ...
	            <tr> 
		            <td style="HEIGHT: 18px" align="right" Width="30%"><asp:label id="Label14" runat="server" Width="100px">ACK Send Flag:</asp:label></td>
		            <td Width="70%">
		            <asp:dropdownlist id="ddlAckSendFlag" runat="server" Width="80px"  >
		                <asp:ListItem Text="All" Selected="True"></asp:ListItem>
