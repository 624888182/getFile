...
public class DataDN_3B2
{

    public int GetDn3B2(string io, string type, string DBReadString, string DBWriString,string DBReadDetail, string Autoprg)
	...
	{  
        ...
        try 
        {
            ...
            //-------------------查詢detail數據------------------------------------------//
            str4 = "select a.invoice_number DN,'" + V_DocID + "' DOCUMENTID,'' UIDNUM,d.batch_no BATCH_NUMBER,b.carton_no CARTONID,b.imei IMEI_NO,"
                           + "to_char(a.creation_date,'YYYY/MM/DD HH24:Mi:SS') MANUFACTURE_DATE,pallet_number_new PALLETID,b.serial_no SERIAL_ID,to_char(a.creation_date,'YYYY/MM/DD HH24:Mi:SS') DATESTAMP ";
            str4 = str4 + ",a.item_number productid,a.so_line_no linenumber ";
            str4 = str4 + "from  ";
            str4 = str4 + "SAP.CMCS_SFC_PACKING_LINES_ALL a, ";
            str4 = str4 + "shp.cmcs_sfc_shipping_data b,  ";
            str4 = str4 + "shp.cmcs_sfc_imeinum c, ";
            str4 = str4 + "shp.cmcs_sfc_porder d ";
            ...
            str4 = str4 + "and b.work_order= d.porder order by imei ";
