...
public abstract class OracleHelper
{
    ...
    /// </summary>
    /// <returns></returns>
    public static bool IsConnectSuccess()
    {
    ...
    public static int GetSumQty(string FieldName, string TableName, string strWhere)
    {
        string strsql = "select sum(" + FieldName + ") from " + TableName + " where " + strWhere;
    ...
    {
        string strsql = "select max(" + FieldName + ")+1 from " + TableName + " " + strWhere;
        object obj = GetSingle(strsql);
        if (obj == null)
        {
            return 1;
    ...
    /// <param name="SQLString">SQL语句</param>
    /// <returns>影响的记录数</returns>
    public static int ExcuteSqlNew(string SQLString)
    {
    ...
    /// <param name="SQLString">查询语句</param>
    /// <returns>DataSet</returns>
    public static DataSet QueryNew(string SQLString)
    {
        using (OracleConnection connection = new OracleConnection(connectionString1))
        {
            DataSet ds = new DataSet();
    ...
    /// <param name="SQLString">SQL语句</param>
    /// <returns>影响的记录数</returns>
    public static int ExecuteSqlTONORMAL(string SQLString, params OracleParameter[] cmdParms)
    {
    ...
    /// <returns></returns>
    public static OracleDataReader ExecuteReaderNew(string SQLString, params OracleParameter[] cmdParms)
    {
    ...
    public static void ExcuteSqlNew(string sqlinstert, OracleParameter[] op)
    {
        throw new NotImplementedException();
    }
}
