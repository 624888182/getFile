<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SCMPO_Change_Detail.aspx.cs" Inherits="MainBBRYPrg_Change_BBSCMPODetail" %>
...
<body bgcolor="#ffffff">
    ...
    <table cellpadding="2" class="style10">
        <tr>
            <td>
                  <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID,ITEMID" 
                      OnRowEditing= "GridView_Edit" 
...
<asp:BoundField DataField="IncoTermsName" HeaderText="IncoTermsName" />
 ...
 style="border-collapse: collapse;  text-align: center; width: 1005px; height: 179px;">
                            ...
                            <td>  </td><td> ITEM </td>
                                ...
                                <td style="width: 100px;"> 
                                        Demand</td><td style="width: 100px;">Confirm&nbsp;</td>
                            </tr>
                            <tr> <td>1</td><td>  
                                    <asp:TextBox ID="TextBox17" runat="server" Width="77px"></asp:TextBox>
                                    </td>
                                <td class="style15">
                            ...
                            <tr><td>2</td><td>  
                                    <asp:TextBox ID="TextBox18" runat="server" Width="77px"></asp:TextBox>
                                    </td>
                                <td class="style15">
                            ...
                            <tr><td>3</td><td>  
                                    <asp:TextBox ID="TextBox19" runat="server" Width="77px"></asp:TextBox>
                                    </td>
                                <td class="style15">
                            ...
                            <tr><td>4</td><td>  
                                    <asp:TextBox ID="TextBox20" runat="server" Width="77px"></asp:TextBox>
                                    </td>
                                <td class="style15">
                            ...
                            <tr><td>5</td><td>  
                                    <asp:TextBox ID="TextBox21" runat="server" Width="77px"></asp:TextBox>
                                    </td>
                                <td class="style15">
                            ...
                            <tr><td>6</td><td>  
                                    <asp:TextBox ID="TextBox22" runat="server" Width="77px"></asp:TextBox>
                                    </td>
                                <td class="style15">
                            ...
                            <tr><td>7</td><td>  
                                    <asp:TextBox ID="TextBox23" runat="server" Width="77px"></asp:TextBox>
                                    </td>
                                <td class="style15">
                            ...
                            <tr><td>8</td><td>  
                                    <asp:TextBox ID="TextBox24" runat="server" Width="77px"></asp:TextBox>
                                    </td>
                                <td class="style15">
